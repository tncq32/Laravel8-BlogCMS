        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                                        ...
                                        <div data-kt-search-element="content"
                                            ...
                                            <form data-kt-search-element="preferences" class="pt-1 d-none">
                                                ...
                                                <div class="d-flex justify-content-end pt-7">
                                                    ...
                                                    <button type="submit"
                                                        class="btn btn-sm fw-bold btn-primary">Kaydet</button>
                                                </div>
                                                <!--end::Actions-->
                                            </form>
                                            <!--end::Preferences-->
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid ">
                    ...
                    <div id="kt_app_content_container" class="app-container  container-xxl " style="padding-bottom: 10px; padding-top:10px;">
                        <!--begin::Home card-->
                        <div class="card">
                            <!--begin::Body-->
                                ...
                                <div class="mb-17">
                                    ...
                                    <div class="row">
                                        ...
                                        @foreach ($blog as $blogs)
                                            <!--end::Feature post-->
                                            <div class="col-md-3 justify-content-between d-flex flex-column">
                                                <!--begin::Post-->
                                                <div class="ps-lg-6 mb-16">
                                                    ...
                                                    <div class="d-flex flex-stack flex-wrap">
                                                        ...
                                                        <!--begin::Label-->
                                                        <span
                                                            class="badge badge-light-info fw-bold my-2">{{ $blogs->category_id }}</span>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Footer-->
                                                </div>
                                            ...
                                            <!--end::Feature post-->
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <a href=""
                                                            class="fw-bold text-gray-900 mb-4 fs-2 lh-base text-hover-primary">
                                                            {{ $hakkimizda->hakkimizdakisayazi }} </a>
                                                        <!--end::Title-->
                                            ...
                                            <div class="col-md-3 justify-content-between d-flex flex-column">
                                                ...
                                                <div class="ps-lg-6 mb-16">
                                                    ...
                                                    <div class="mb-6">
                                                        <!--begin::Title-->
                                                        <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                                            style="{{ asset($kategori->front_image) }}')"
                                                            data-fslightbox="lightbox-video-tutorials" href="#">

                                                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                                                style="background-image:url({{ asset($kategori->front_image) }})">
                                                            </div>
                                                        </a>
                                                        <a href="{{ route('blog.webShowBlog', ['title' => $kategori->title, 'id' => $kategori->id]) }}"
                                                            class="fw-bold text-gray-900 mb-4 fs-2 lh-base text-hover-primary">
                                                            {{ $kategori->title }} </a>
                                                        <!--end::Title-->
                                    ...
                                    <div class="row g-5 mb-5 mb-lg-15 ">
                                        ...
                                        <div class="col-sm-6 pe-lg-10">
                                            ...
                                            <div
                                                ...
                                                <!--begin::Icon-->
                                                <i class="ki-duotone ki-briefcase fs-3tx text-primary"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                                <!--end::Icon-->
                                        ...
                                        <div class="col-sm-6 ps-lg-10">
                                            ...
                                            <div
                                                ...
                                                <!--begin::Icon-->
                                                <i class="ki-duotone ki-geolocation fs-3tx text-primary"><span
                                                        class="path1"></span><span class="path2"></span></i>
                                                <!--end::Icon-->
                                ...
                                <div class="mb-17">
                                    ...
                                    <div class="card mb-4 bg-light text-center">
                                        ...
                                        <div class="card-body py-12">
                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->facebook)
                                                <a href="{{$sosyalmedya->facebook}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/facebook-4.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->

                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->instagram)
                                                <a href="{{$sosyalmedya->instagram}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/instagram-2-1.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->

                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->github)
                                                <a href="{{$sosyalmedya->github}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/github.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->

                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->behance)
                                                <a href="{{$sosyalmedya->behance}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/behance.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->

                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->pinterest)
                                                <a href="{{$sosyalmedya->pinterest}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/pinterest-p.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->

                                            <!--begin::Icon-->
                                            @if($sosyalmedya && $sosyalmedya->twitter)
                                                <a href="{{$sosyalmedya->twitter}}" class="mx-4">
                                                    <img src="demo1/media/svg/brand-logos/twitter.svg" class="h-30px my-2" alt="">
                                                </a>
                                            @endif
                                            <!--end::Icon-->
                                        </div>
                ...
                <div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
                    ...
                    <div
                        ...
                        <!--begin::Copyright-->
                        <div class="text-gray-900 order-2 order-md-1" style="text-align: center;">
