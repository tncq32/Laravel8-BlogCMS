    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                            ...
                            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                                        ...
                                        <div class="d-flex align-items-center" data-kt-search-element="toggle"
                                            ...
                                            <div
                                                ...
                                                <i class="bi-search"><span class="path1"></span><span
                                                        class="path2"></span></i>
                                            </div>
                                        </div>
                                        <!--end::Search toggle-->
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3">
                                    ...
                                    <a href="#"
                                        ...
                                        <i class="bi-list"><span class="path1"></span><span
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start  container-xxl " style="padding-bottom: 10px; padding-top:10px;">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 pe-lg-10">
                                        ...
                                        <form action=""
                                            ...
                                            <h1 class="fw-bold text-gray-900 mb-9">Bizimle İletişime Geç!</h1>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                    <!--begin::Label-->
                                                    <label class="fs-5 fw-semibold mb-2">İsim Soyisim</label>
                                                    <!--end::Label-->
                                    ...
                                    <div class="col-md-6 ps-lg-10">
                                        <div class="mb-10">
                                            @if($iletisim && $iletisim->harita_iframe)
                                                <iframe
                                                    width="100%"
                                                    height="400"
                                                    frameborder="0"
                                                    style="border:0"
                                                    src="{{ $iletisim->harita_iframe }}"
                                                    allowfullscreen
                                                ></iframe>
                                            @else
                                                <p>Harita iframe bulunamadı.</p>
                                            @endif
                                        </div>
                                    </div>
                                    <!--end::Col-->
