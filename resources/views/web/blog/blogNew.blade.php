        ...
        <div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="#" class="btn btn-flex bg-body h-35px h-lg-40px px-5" id="kt_dashboard_daterangepicker"
                    ...
                    data-bs-original-title="Select dashboard daterange" data-kt-initialized="1">
                    <span class="me-4">
                        <span class="text-muted fw-semibold me-1" id="kt_dashboard_daterangepicker_title">Today:</span>
                        <span class="text-primary fw-bold" id="kt_dashboard_daterangepicker_date">Sep 27</span>
                    </span>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                                ...
                                <option @if(request()->get('blog_status')=='active') selected @endif value="active">Aktif
                                </option>
                                <option @if(request()->get('blog_status')=='passive') selected @endif value="passive">Pasif
                                </option>
                            </select>
                            <!--end::Select2-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                                ...
                                data-kt-initialized="1" name="blog_category_id">
                                <option></option>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2 select2-hidden-accessible" data-control="select2"
                                ...
                                aria-hidden="true" data-kt-initialized="1">
                                <option></option>
                                <option value="default" selected="" data-select2-id="select2-data-12-sy71">No Sidebar</option>
                                <option value="electronics">Left Sidebar</option>
                                <option value="office">Right Sidebar</option>
                                <option value="fashion">Center</option>
                            ...
                            <div class="d-flex flex-column gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row mb-2">
                                            ...
                                            <div class="dropzone dz-clickable" id="kt_ecommerce_add_product_media">
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="ms-4">
                                                        <h3 class="fs-5 fw-bold text-gray-900 mb-1">Dosyaları buraya bırakın veya
                                                            yüklemek için tıklayın.</h3>
                                                        <span class="fs-7 fw-semibold text-gray-400">En fazla 10 adet dosya yükleyiniz</span>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                            </div>
                                        ...
                                        <!--begin::Description-->
                                        <div class="text-muted fs-7">Blog medya galerisini ayarlayın.</div>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Card header-->
                                </div>
