    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0"
                                        ...
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><a href="/hakkimizda"><span
                                        ...
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                            data-kt-menu-placement="bottom-start"
                                            class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                            <!--begin:Menu link--><a href="/iletisim"><span
                                                    class="menu-link py-3"><span
                ...
                <div id="kt_app_content" class="app-content  flex-column-fluid " style="padding-bottom: 10px; padding-top:10px;">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-lg-20 pb-lg-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4"
                                        @if ($blog->blog_sidebar == 'right' || $blog->blog_sidebar == 'center') style="display: none;" @endif>
                                        <!--end::Content-->

                                        <!--begin::Search blog-->
                                        <div class="mb-16">
                                            <h4 class="text-gray-900 mb-7">Blog Ara</h4>
                                        ...
                                        <!--begin::Catigories-->
                                        <div class="mb-16">
                                            <h4 class="text-gray-900 mb-7">Kategoriler</h4>
                                            @foreach ($blogCategory as $kategori)
                                                <!--begin::Item-->
                                        ...
                                        <!--begin::Recent posts-->
                                        <div class="m-0">
                                            <h4 class="text-gray-900 mb-7">Son Gönderiler</h4>
                                            @foreach ($blog as $blogs)
                                                <div class="d-flex flex-stack mb-7">
                                                    ...
                                                    <div class="m-0">
                                                        ...
                                                        <span
                                                            class="text-gray-600 fw-semibold d-block pt-1 fs-7"></span>
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="col-md-8">
                                                ...
                                                <div class="mb-8">
                                                    ...
                                                    <div class="d-flex flex-wrap mb-6">
                                                        ...
                                                        <div class="me-9 my-1">
                                                            ...
                                                            <!--begin::Label-->
                                                            <span
                                                                class="fw-bold text-gray-500">{{ $blog->created_at }}</span>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Item-->
                                        ...
                                        -->
                                                        ...
                                                        <div class="my-1">
                                                            ...
                                                            <!--begin::Label-->
                                                            <span class="fw-bold text-gray-500">24 Yorum</span>
                                                            <!--end::Label-->
                                                        </div>
                                                        <!--end::Item-->
                                                    </div>
                                    ...
                                    <div class="col-md-4"
                                        @if ($blog->blog_sidebar == 'left' || $blog->blog_sidebar == 'center') style="display: none;" @endif>
                                        <!--end::Content-->
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex align-items-center flex-grow-1">
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a href="#" class="text-gray-900 text-hover-primary fs-6 fw-bold">{{ auth()->user()->name }}</a>
                                        ...
                                        <form id="kt_forms_widget_1_form" class="ql-quil ql-quil-plain pb-3"
                                            ...
                                            action="{{ route('blog.webCreateComments', ['title' => $blog->blog_title, 'id' => $blog->id]) }}"
                                            ...
                                            <div class="ql-toolbar ql-snow">
                                                <div id="kt_ecommerce_add_product_description"
                                                    ...
                                                    <textarea name="content" id="" cols="100" rows="10" placeholder="Ne Düşünüyorsunuz?"></textarea>
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <div class="d-flex align-items-center flex-grow-1">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="#"
                                                            class="text-gray-900 text-hover-primary fs-6 fw-bold">{{ $comment->user->name }}</a>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div class="d-flex align-items-center mb-5">
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        <i class="ki-duotone ki-heart fs-2"><span
                                                                class="path1"></span><span class="path2"></span></i>
                                                        15
                                                    </a>
                                                </div>
                            ...
                            <form class="position-relative mb-6">
                                <textarea class="form-control border-0 p-0 pe-10 resize-none min-h-25px" data-kt-autosize="true" rows="1"
                                    placeholder="Reply.." style="overflow: hidden; overflow-wrap: break-word; text-align: start; height: 25px;"
                                    data-kt-initialized="1"></textarea>
