    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start  container-xxl " style="padding-top: 10px; padding-bottom:10px;">
                                ...
                                <div class="mb-18">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="text-center mb-15">
                                            <!--begin::Title-->
                                            <h3 class="fs-2hx text-gray-900 mb-5">Hakkımızda</h3>
                                            <!--end::Title-->

                                            <!--begin::Text-->
                                            <div class="fs-5 text-muted fw-semibold">
                                                <p name="hakkimizdakisayazi">
                                               {{$hakkimizda->hakkimizdakisayazi}}
                                                </p>
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                    ...
                                    <div class="fs-5 fw-semibold text-gray-600">
                                        <!--begin::Text-->
                                        <p class="mb-8" name="hakkimizdaicerik">
